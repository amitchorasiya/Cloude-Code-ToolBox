...
import com.amitchorasiya.cloude.toolbox.intellij.http.RegistryHttp
import com.amitchorasiya.cloude.toolbox.intellij.http.SkillsShHttp
import com.amitchorasiya.cloude.toolbox.intellij.mcp.McpHubActions
import com.amitchorasiya.cloude.toolbox.intellij.mcp.McpRegistryInstall
import com.amitchorasiya.cloude.toolbox.intellij.settings.ToolboxSettings
import com.amitchorasiya.cloude.toolbox.intellij.skills.SkillFolderDelete
import com.amitchorasiya.cloude.toolbox.intellij.skills.SkillHubState
import com.amitchorasiya.cloude.toolbox.intellij.skills.SkillsCli
...
object HubMessageHandler {
    ...
    private fun notify(project: Project, text: String, type: NotificationType = NotificationType.INFORMATION) {
        Notifications.Bus.notify(
            Notification("CloudeCodeToolBox", "Cloude Code ToolBox", text, type),
            project,
        )
    }
